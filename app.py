...
@st.cache_resource
def build_preprocessor(df): # takes df
...
@st.cache_resource
def load_model(path='ada_boost_churn_model.pkl'): # load the ada_boost_churn_model.pkl file
...
def main(): # first function runs when executed
